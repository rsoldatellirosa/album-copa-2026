...
export default function InstallPWA() {
  ...
  return (
    <>
      <button
        onClick={handleClick}
        className="ml-1 px-2.5 py-1.5 rounded bg-coral text-white text-sm font-semibold hover:brightness-95 whitespace-nowrap"
      ...
      {iosHelp && (
        ...
        >
          <div
            className="bg-paper rounded-lg p-5 w-full max-w-sm"
          ...
          >
            ...
            <button
              onClick={() => setIosHelp(false)}
              className="mt-4 w-full py-2 rounded bg-mint-deep text-white font-medium"
            >
              Entendi
            </button>
          </div>
