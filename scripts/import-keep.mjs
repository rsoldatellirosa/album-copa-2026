// Importa as listas do Keep (keep-2026-06-data.json):
//   novas    -> owned=true (preserva duplicates)
//   repetidas-> owned=true, duplicates += 1
// Modo ADD (soma nas repetidas existentes).
...
const data = JSON.parse(readFileSync(join(__dirname, "keep-2026-06-data.json"), "utf8"));
